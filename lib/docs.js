 ...
 * @param {boolean} [args.fillLastColumn=false] - When true, the last visible column expands to the right edge of the grid when the columns do not fill its width. The outer edge of that column cannot be resized.
